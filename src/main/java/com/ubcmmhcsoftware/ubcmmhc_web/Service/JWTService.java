 ...
 * <p>
 * This service handles the Creation (Signing), Parsing (Decoding), and
 * Validation
...
public class JWTService {
     ...
     * * @param secret The secret string from application.properties used to sign
     * tokens.
     ...
     * @param claimsResolver A function defining which claim to extract (e.g.,
     *                       Claims::getSubject).
