...
/**
 * Core Security Service that acts as a bridge between the Database and Spring Security.
 * <p>
 * This class implements the standard Spring Security interface {@link UserDetailsService}.
 * Its primary job is to load user data (like passwords and roles) from the database
...
public class CustomUserDetailsService implements UserDetailsService {
     ...
     * It fetches the {@link User} entity and wraps it in a {@link CustomUserDetails} object,
     ...
     * <p>
     * This method is typically used by the JWT Filter. When a request comes in with a token,
